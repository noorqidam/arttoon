...
export const handleGetMyWebtoons = (param) => ({
  ...
  payload: axios({
    method: 'GET',
    url: `https://restapi-arttoon.herokuapp.com/api/v1/user/${param.user}/webtoons`,
    headers: {
...
export const handleAddMyWebtoons = (param) => ({
  ...
  payload: axios({
    method: 'POST',
    url: `https://restapi-arttoon.herokuapp.com/api/v1/user/${param.user}/webtoon`,
    headers: {
      Authorization: `bearer ${param.token}`
    },
    data: param.data
...
export const handleDeleteMyWebtoons = (param) => ({
  ...
  payload: axios({
    method: 'DELETE',
    url: `https://restapi-arttoon.herokuapp.com/api/v1/user/${param.user}/webtoon/${param.webtoon}`,
    headers: {
      Authorization: `bearer ${param.token}`
    }
  })
